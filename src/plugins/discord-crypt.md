...
<h1 align="center">
    <img src="https://i.imgur.com/QVSsa0O.png"
        height="50" width="50">
    DiscordCrypt™ <h3>End-To-End File & Message Encryption For Discord</h3>
</h1>

![Encrypted Message](https://i.imgur.com/YEauqTu.png)
...
If you'd like an in-depth explanation of its inner workings, click [here](https://gitlab.com/leogx9r/DiscordCrypt/blob/master/TECHNICALITIES.md).
...
Contributions are welcome! Be sure to read [our guidelines](https://gitlab.com/leogx9r/DiscordCrypt/blob/master/CONTRIBUTING.md) before submitting
    your changes.
...
![Menu Bar](https://i.imgur.com/6tEn9LH.png)
...
![Greeting Prompt](https://i.imgur.com/Si6J1Tx.png)
...
If you wish to change your master password, you may do so in the `Plugin Settings` menu.
    ( ![settings-menu](https://i.imgur.com/MRSemhU.png) )
...
![master-password](https://i.imgur.com/KVhyuhz.png)
...
* Open the `Password Settings` menu. ( ![5](https://i.imgur.com/oShhXlP.png) )
...
If it comes to this, you simply need to go to the `Password Settings` menu
    ( ![6](https://i.imgur.com/oShhXlP.png) ) to apply or reset your passwords for the channel
...
Be sure to read the [contribution](https://gitlab.com/leogx9r/DiscordCrypt/blob/master/CONTRIBUTING.md) guidelines before creating an issue.
...
* [Initial E2E Request Denied](https://i.imgur.com/MHgkjpW.png)
* [Refusal For User Data Deletion](https://i.imgur.com/dNclIun.png)
* [Government Requests For User Data](https://i.imgur.com/dNclIun.png)
...
* ***DiscordCrypt™'s key exchange is vulnerable to Discord's servers being used for
    ...
    * While an attacker would need access to Discord's infrastructure as the data is
        ...
        key exchange.
        * We discussed this in greater details in the [https://gitlab.com/leogx9r/DiscordCrypt/blob/master/TECHNICALITIES.md](https://gitlab.com/leogx9r/DiscordCrypt/blob/master/https://gitlab.com/leogx9r/DiscordCrypt/blob/master/TECHNICALITIES.md) file.
