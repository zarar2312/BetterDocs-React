...
const Footer = () => (
  ...
  >
    <svg className={mystyles.background} preserveAspectRatio='none' width='1920'viewBox='0 0 1920 330'
    >
        <path className={mystyles.blob} fillOpacity='0.04' d='M140.881198,194.260295 C257.600568,129.32862 342.939626,119.84993 418.009939,203.154617 C493.080251,286.459305 545.728689,70.9046172 636.439626,63.9593047 C727.150564,57.0139922 768.99822,139.670242 858.802907,119.431961 C948.607595,99.1936797 1071.91228,-32.9977266 1243.91228,7.75227342 C1415.91228,48.5022734 1404.10369,208.584305 1508.27166,178.709305 C1612.43963,148.834305 1633.73291,79.913472 1711.63588,98.8569055 C1776.28676,114.577866 1819.96778,221.391836 1889.37253,185.808108 C2017.32661,120.206212 2004.01952,336.769569 2004.01952,336.769569 L271.635881,337 L-149.063338,337 C-149.063338,337 -245.850307,175.637635 -58.0633382,228.867188 C33.8652851,254.92501 64.1722713,236.933925 140.881198,194.260295 Z'
        />
    </svg>
    ...
    >
        ...
        <li className={mystyles.itemFirst}
        >
        <div className={mystyles.logo}
        >
            <svg xmlns='http://www.w3.org/2000/svg' id='Calque_1' viewBox='0 0 1100.2603 578.46808' width='90' height='50'>
        ...
        <li className={mystyles.item}
        >
            <h4 className={mystyles.h4}
            >
            General
            </h4>
            <ul className={mystyles.subList}
            >
            <li className={mystyles.subItem}
            >
                <Link to="/" className={mystyles.link}
                >
                    Home
                </Link>
            </li>
            <li className={mystyles.subItem}
            >
                <Link to="/themes/" className={mystyles.link}
                >
                    Themes
                </Link>
            </li>
            <li className={mystyles.subItem}
            >
                <Link to="/plugins/" className={mystyles.link}
                >
                    Plugins
                </Link>
            </li>
        ...
        >
            ...
            <li className={mystyles.subItem}
            >
                <Link to="/getting-started/" className={mystyles.link}
                >
                    Getting Started
                </Link>
            </li>
            <li className={mystyles.subItem}
            >
                <Link to="/contact/" className={mystyles.link}
                >
                    Contact
                </Link>
            </li>
        ...
        <li className={mystyles.itemLast}
        >
            <h4 className={mystyles.h4}
            >
            Contact Us
            ...
            >
                ...
                <a className="decorated" href="mailto:betterdocs@support.com"
                >
